...
#
# Script generated by Vivado on Thu May 23 21:39:43 +0300 2024
...
# script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/catal/Documents/GitHub/FPGA-Image-Processing/Ov7670_Camera_test/Ov7670_Camera_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
